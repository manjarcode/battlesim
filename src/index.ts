...
function createFighter(name: string, attack: Attack, defence: Defense, health: number, initiative: number): Fighter {
  return new Fighter(name, attack, defence, health, initiative)
}

function createBeastTeam(): Group {
...
function createPlayersTeam(): Group {
...
function createFirearmedPlayersTeam(): Group {
  return new Group('Players Team', [
